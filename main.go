...
func main() {
	...
	r.Use(cors.New(cors.Config{
		AllowOrigins:     []string{"localhost:4200", "http://localhost:4200", "http://localhost:4200/"},
	...
	group.PUT("/updateFighter/:id", models.UpdateFighter(db))    //Mismo problema anterior jaja xd sadfsadf
